...
model Salary= Experience bachelors graduate_degree Mgr E1M E2M / clb;
...
proc sgplot data=diagnostic;
  title 'Fitted Model';
  scatter x=experience y=Salary / group=category ;
  series x=experience y=fits /  group=category lineattrs=GraphPrediction 
