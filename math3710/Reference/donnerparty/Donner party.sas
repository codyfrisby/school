...
proc logistic data = donner descending;
  model survive = age / lackfit influence iplots ctable outroc=ROCData;
  run;
...
proc logistic data = donner descending;
  model survive = age sex /lackfit influence iplots ctable outroc=ROCData;
  run;
...
proc logistic data = donner descending;
  model survive = age sex age*sex /lackfit influence iplots ctable outroc=ROCData;
  output out=a p=pi;
  run;
